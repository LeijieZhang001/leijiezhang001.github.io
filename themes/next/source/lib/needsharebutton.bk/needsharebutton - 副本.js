  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "wechat": function (el) {
        ...
        var imgSrc = "http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + encodeURIComponent(myoptions.url);		var dropdownEl = el.querySelector(".need-share-button_dropdown");
